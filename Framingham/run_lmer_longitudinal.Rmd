...
write.csv(relevant_snps_results, '/work/larylab/Griffin_Stuff/Griffin_Framingham/results/FULL_POWER_FN_AllSNPs_LMER_results_female.csv')
write.csv(relevant_snps_emmeans, '/work/larylab/Griffin_Stuff/Griffin_Framingham/results/FULL_POWER_FN_AllSNPs_LMER_emmeans_female.csv')
```
